...
public class BlueCorner extends OpMode {
    ...
    enum State {
        Start, DetectPicture , square, AlignToCryptobox ,
        push, GetMoreGylphs,JewelArm, KnockOffJewel,DriveForwardMore,
        DriveOffBalancingStone, Straighten, Align, TurnSideWays, PutItInTheHole, BackOffBox, Kill
    }
