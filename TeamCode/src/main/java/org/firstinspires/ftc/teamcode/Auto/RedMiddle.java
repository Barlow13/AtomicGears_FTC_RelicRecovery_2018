...
public class RedMiddle extends OpMode {
    ...
    enum State {
            Start, DetectPicture , DriveOff , drive, square, Turn , AlignToCryptobox , PlaceFirstGylph , PLaceGylph, push, GetMoreGylphs, ComeBack, HitBox, PlaceMoreGylphs, Jitter, Jitter2, JewelArm, KnockOffJewel, SquareUpAgain, DriveForwardMore, BackOff, Straighten, RamPile, placegylph, Kill
        }
        ...
        public void loop() {
            ...
            case Straighten:
                ...
                case DriveOff:
                    if (right)
                    {robot.Forward(.8,8.75);
                    if (robot.DriveDone(8.75)){
                            robot.Kill();
                            state = State.Turn;
                            time.reset();
                        }
